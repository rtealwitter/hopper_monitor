...
Last updated: 2026-08-19T05:30:13-07:00
Samples: 653 queue snapshots total (334 in the last 7 days), 636 GPU snapshots total (317 in the last 7 days)
...
- **42.9%** (last 7 days) vs **46.8%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **48.4%** (last 7 days) vs **50.9%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2658.0</td><td align='right'>5017.0</td><td align='right'>65%</td><td align='right'>69%</td></tr>
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1085.0</td><td align='right'>3042.5</td><td align='right'>27%</td><td align='right'>32%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-12 05:30 to 2026-08-19 05:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **5991** readings the former missed.
...
One point per user per snapshot (n=1275), usage decayed on Slurm's ~7-day fairshare half-life.
