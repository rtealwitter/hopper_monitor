...
Last updated: 2026-09-01T09:30:12-07:00
Samples: 1262 queue snapshots total (334 in the last 7 days), 1188 GPU snapshots total (313 in the last 7 days)
...
- **46.9%** (last 7 days) vs **41.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **66.8%** (last 7 days) vs **54.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **46.2%** (last 7 days) vs **69.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4679.5</td><td align='right'>11173.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 09:30 to 2026-09-01 09:30** (PDT).
...
One point per user per snapshot (n=874), usage decayed on Slurm's ~7-day fairshare half-life.
