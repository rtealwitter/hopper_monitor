...
Last updated: 2026-08-22T01:33:58-07:00
Samples: 789 queue snapshots total (334 in the last 7 days), 762 GPU snapshots total (307 in the last 7 days)
...
- **27.0%** (last 7 days) vs **42.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
...
Based on 18 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (29.7% of GPUs allocated on average) and around **01:00-02:00** (35.6% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>309.5</td><td align='right'>3122.0</td><td align='right'>21%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-15 01:33 to 2026-08-22 01:33** (PDT).
...
One point per user per snapshot (n=1055), usage decayed on Slurm's ~7-day fairshare half-life.
