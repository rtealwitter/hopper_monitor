...
Last updated: 2026-08-09T04:30:25-07:00
Samples: 173 queue snapshots total (173 in the last 7 days), 173 GPU snapshots total (173 in the last 7 days)
...
- **44.0%** (last 7 days) vs **44.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **47.2%** (last 7 days) vs **47.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **86.7%** (last 7 days) vs **86.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1098.5</td><td align='right'>1098.5</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>653.0</td><td align='right'>653.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 04:30 to 2026-08-09 04:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3210** readings the former missed.
...
One point per user per snapshot (n=794), usage decayed on Slurm's ~7-day fairshare half-life.
