...
Last updated: 2026-08-18T22:30:17-07:00
Samples: 639 queue snapshots total (334 in the last 7 days), 622 GPU snapshots total (317 in the last 7 days)
...
- **44.9%** (last 7 days) vs **47.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **49.1%** (last 7 days) vs **50.9%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **82.6%** (last 7 days) vs **80.8%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2785.0</td><td align='right'>4926.0</td><td align='right'>66%</td><td align='right'>69%</td></tr>
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1161.0</td><td align='right'>3042.5</td><td align='right'>26%</td><td align='right'>32%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-11 22:30 to 2026-08-18 22:30** (PDT).
...
One point per user per snapshot (n=1302), usage decayed on Slurm's ~7-day fairshare half-life.
