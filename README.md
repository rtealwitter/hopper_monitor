...
Last updated: 2026-08-14T00:00:23-07:00
Samples: 404 queue snapshots total (336 in the last 7 days), 404 GPU snapshots total (336 in the last 7 days)
...
- **55.4%** (last 7 days) vs **55.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
...
Based on 10 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (29.6% of GPUs allocated on average) and around **00:00-01:00** (46.9% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>3556.5</td><td align='right'>3703.5</td><td align='right'>70%</td><td align='right'>70%</td></tr>
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1957.5</td><td align='right'>2491.5</td><td align='right'>29%</td><td align='right'>33%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-07 00:00 to 2026-08-14 00:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **7193** readings the former missed.
