...
Last updated: 2026-08-24T05:00:03-07:00
Samples: 881 queue snapshots total (321 in the last 7 days), 837 GPU snapshots total (281 in the last 7 days)
...
- **39.5%** (last 7 days) vs **49.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-d58f5a15</td><td align='right'>400.0</td><td align='right'>1023.5</td><td align='right'>5%</td><td align='right'>7%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-17 05:00 to 2026-08-24 05:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2522** readings the former missed.
