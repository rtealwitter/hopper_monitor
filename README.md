...
Last updated: 2026-08-31T16:00:30-07:00
Samples: 1227 queue snapshots total (328 in the last 7 days), 1153 GPU snapshots total (305 in the last 7 days)
...
- **45.9%** (last 7 days) vs **41.3%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.3%** (last 7 days) vs **54.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **43.4%** (last 7 days) vs **70.0%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4509.5</td><td align='right'>10820.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 16:00 to 2026-08-31 16:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **893** readings the former missed.
...
One point per user per snapshot (n=790), usage decayed on Slurm's ~7-day fairshare half-life.
