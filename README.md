...
Last updated: 2026-09-09T05:30:30-07:00
Samples: 1638 queue snapshots total (336 in the last 7 days), 1472 GPU snapshots total (244 in the last 7 days)
...
- **20.4%** (last 7 days) vs **36.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **42.1%** (last 7 days) vs **52.6%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **95.8%** (last 7 days) vs **82.4%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1210.5</td><td align='right'>4415.5</td><td align='right'>19%</td><td align='right'>28%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>739.5</td><td align='right'>12213.0</td><td align='right'>78%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-09-02 05:30 to 2026-09-09 05:30** (PDT).
...
One point per user per snapshot (n=1127), usage decayed on Slurm's ~7-day fairshare half-life.
