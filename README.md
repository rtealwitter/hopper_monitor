...
Last updated: 2026-08-31T18:00:28-07:00
Samples: 1231 queue snapshots total (330 in the last 7 days), 1157 GPU snapshots total (308 in the last 7 days)
...
- **46.6%** (last 7 days) vs **41.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.4%** (last 7 days) vs **54.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **43.2%** (last 7 days) vs **69.8%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4606.0</td><td align='right'>10924.0</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 18:00 to 2026-08-31 18:00** (PDT).
...
One point per user per snapshot (n=800), usage decayed on Slurm's ~7-day fairshare half-life.
