...
Last updated: 2026-09-01T14:00:19-07:00
Samples: 1271 queue snapshots total (336 in the last 7 days), 1197 GPU snapshots total (316 in the last 7 days)
...
- **46.1%** (last 7 days) vs **41.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **66.5%** (last 7 days) vs **54.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **49.2%** (last 7 days) vs **69.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4649.5</td><td align='right'>11265.5</td><td align='right'>66%</td><td align='right'>64%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-f5bf0d80</td><td align='right'>1.0</td><td align='right'>33.5</td><td align='right'>28%</td><td align='right'>44%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 14:00 to 2026-09-01 14:00** (PDT).
...
One point per user per snapshot (n=900), usage decayed on Slurm's ~7-day fairshare half-life.
