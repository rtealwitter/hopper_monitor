...
Last updated: 2026-09-02T18:30:09-07:00
Samples: 1328 queue snapshots total (336 in the last 7 days), 1245 GPU snapshots total (322 in the last 7 days)
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4579.0</td><td align='right'>11477.5</td><td align='right'>65%</td><td align='right'>64%</td></tr>
...
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-7d156b54</td><td align='right'>4.5</td><td align='right'>6.0</td><td align='right'>49%</td><td align='right'>47%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-26 18:30 to 2026-09-02 18:30** (PDT).
...
2. **Escalate on sustained low utilization** (see table and scatter above). Current top candidate (most idle GPU-hours over the last 7d): `user-554c620c` in `witter-lab` - 1592 idle of 4579.0 GPU-hours allocated (65% utilization). Needs a utilization threshold (e.g. <20% mean over 50+ GPU-hours) and a grace period, then either a soft nudge (Slack/email) or a hard QOS penalty (`sacctmgr modify qos ... set Priority-=<n>`). Neither exists yet - this is read-only signal, not enforced policy.
