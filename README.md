...
Last updated: 2026-08-09T03:00:23-07:00
Samples: 170 queue snapshots total (170 in the last 7 days), 170 GPU snapshots total (170 in the last 7 days)
...
- **43.4%** (last 7 days) vs **43.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **46.7%** (last 7 days) vs **46.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **87.2%** (last 7 days) vs **87.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1076.0</td><td align='right'>1076.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>605.0</td><td align='right'>605.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 03:00 to 2026-08-09 03:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3128** readings the former missed.
...
One point per user per snapshot (n=782), usage decayed on Slurm's ~7-day fairshare half-life.
