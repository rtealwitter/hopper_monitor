...
Last updated: 2026-08-09T05:00:27-07:00
Samples: 174 queue snapshots total (174 in the last 7 days), 174 GPU snapshots total (174 in the last 7 days)
...
- **47.3%** (last 7 days) vs **47.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **86.5%** (last 7 days) vs **86.5%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1106.0</td><td align='right'>1106.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>669.0</td><td align='right'>669.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 05:00 to 2026-08-09 05:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3238** readings the former missed.
