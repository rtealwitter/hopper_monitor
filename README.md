...
Last updated: 2026-08-28T02:30:27-07:00
Samples: 1056 queue snapshots total (313 in the last 7 days), 982 GPU snapshots total (265 in the last 7 days)
...
- **32.5%** (last 7 days) vs **40.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **53.4%** (last 7 days) vs **51.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2881.5</td><td align='right'>8302.0</td><td align='right'>56%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-21 02:30 to 2026-08-28 02:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1491** readings the former missed.
