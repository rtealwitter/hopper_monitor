...
Last updated: 2026-08-10T03:00:23-07:00
Samples: 218 queue snapshots total (218 in the last 7 days), 218 GPU snapshots total (218 in the last 7 days)
...
- **48.4%** (last 7 days) vs **48.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **51.3%** (last 7 days) vs **51.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **80.8%** (last 7 days) vs **80.8%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1370.0</td><td align='right'>1370.0</td><td align='right'>38%</td><td align='right'>38%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1264.0</td><td align='right'>1264.0</td><td align='right'>73%</td><td align='right'>73%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-03 03:00 to 2026-08-10 03:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **4126** readings the former missed.
...
One point per user per snapshot (n=978), usage decayed on Slurm's ~7-day fairshare half-life.
