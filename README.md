...
Last updated: 2026-08-09T11:00:24-07:00
Samples: 186 queue snapshots total (186 in the last 7 days), 186 GPU snapshots total (186 in the last 7 days)
...
- **46.0%** (last 7 days) vs **46.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **49.0%** (last 7 days) vs **49.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **84.2%** (last 7 days) vs **84.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1175.0</td><td align='right'>1175.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>861.0</td><td align='right'>861.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 11:00 to 2026-08-09 11:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3512** readings the former missed.
