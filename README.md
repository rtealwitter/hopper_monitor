...
Last updated: 2026-08-24T04:30:03-07:00
Samples: 881 queue snapshots total (322 in the last 7 days), 837 GPU snapshots total (282 in the last 7 days)
...
- **39.4%** (last 7 days) vs **49.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-d58f5a15</td><td align='right'>404.0</td><td align='right'>1023.5</td><td align='right'>5%</td><td align='right'>7%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-17 04:30 to 2026-08-24 04:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2529** readings the former missed.
...
One point per user per snapshot (n=890), usage decayed on Slurm's ~7-day fairshare half-life.
