...
Last updated: 2026-08-20T05:30:07-07:00
Samples: 701 queue snapshots total (334 in the last 7 days), 675 GPU snapshots total (308 in the last 7 days)
...
- **33.5%** (last 7 days) vs **44.2%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **47.4%** (last 7 days) vs **50.8%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **81.8%** (last 7 days) vs **80.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2012.5</td><td align='right'>5127.0</td><td align='right'>67%</td><td align='right'>69%</td></tr>
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>791.0</td><td align='right'>3042.5</td><td align='right'>26%</td><td align='right'>32%</td></tr>
...
<tr style='background-color:#fbebf1'><td>nerenberg-lab</td><td>user-fedb5feb</td><td align='right'>21.0</td><td align='right'>60.0</td><td align='right'>52%</td><td align='right'>60%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-13 05:30 to 2026-08-20 05:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **4631** readings the former missed.
...
One point per user per snapshot (n=1194), usage decayed on Slurm's ~7-day fairshare half-life.
