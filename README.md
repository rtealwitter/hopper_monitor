...
Last updated: 2026-09-05T08:30:07-07:00
Samples: 1452 queue snapshots total (336 in the last 7 days), 1287 GPU snapshots total (245 in the last 7 days)
...
- **28.1%** (last 7 days) vs **36.7%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **64.2%** (last 7 days) vs **53.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **77.7%** (last 7 days) vs **76.1%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2712.0</td><td align='right'>11486.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>84.0</td><td align='right'>3289.0</td><td align='right'>15%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-29 08:30 to 2026-09-05 08:30** (PDT).
