...
Last updated: 2026-08-07T04:30:16-07:00
Samples: 77 queue snapshots, 77 GPU snapshots
...
- **54.5%** of the cluster's 60 GPUs allocated, averaged across all samples
- **43.9%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **85.4%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#fbebf1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>597.5</td><td align='right'>597.5</td><td align='right'>50%</td></tr>
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>154.0</td><td align='right'>320.5</td><td align='right'>69%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3322.5</td><td align='right'>—</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-eec7ffae</td><td align='right'>0.0</td><td align='right'>412.5</td><td align='right'>—</td></tr>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1904** readings the former missed.
...
One point per user per snapshot (n=388), usage decayed on Slurm's ~7-day fairshare half-life.
