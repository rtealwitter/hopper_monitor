...
Last updated: 2026-08-07T09:30:25-07:00
Samples: 87 queue snapshots, 87 GPU snapshots
...
- **53.9%** of the cluster's 60 GPUs allocated, averaged across all samples
- **44.2%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **86.0%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#fbebf1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>686.0</td><td align='right'>686.0</td><td align='right'>49%</td></tr>
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>212.5</td><td align='right'>542.0</td><td align='right'>66%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3472.5</td><td align='right'>—</td></tr>
<tr style='background-color:#dfeaf8'><td>enkavi-lab</td><td>user-c21bdaa4</td><td align='right'>0.0</td><td align='right'>44.0</td><td align='right'>—</td></tr>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2115** readings the former missed.
...
One point per user per snapshot (n=427), usage decayed on Slurm's ~7-day fairshare half-life.
