...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2932** readings the former missed.
...
One point per user per snapshot (n=748), usage decayed on Slurm's ~7-day fairshare half-life.
