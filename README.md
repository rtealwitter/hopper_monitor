...
Last updated: 2026-08-31T15:30:27-07:00
Samples: 1226 queue snapshots total (328 in the last 7 days), 1152 GPU snapshots total (304 in the last 7 days)
...
- **45.6%** (last 7 days) vs **41.2%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.2%** (last 7 days) vs **54.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **43.5%** (last 7 days) vs **70.1%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4482.0</td><td align='right'>10793.0</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 15:30 to 2026-08-31 15:30** (PDT).
...
One point per user per snapshot (n=788), usage decayed on Slurm's ~7-day fairshare half-life.
