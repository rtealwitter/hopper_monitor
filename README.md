...
Last updated: 2026-09-05T01:00:12-07:00
Samples: 1437 queue snapshots total (336 in the last 7 days), 1272 GPU snapshots total (245 in the last 7 days)
...
- **27.8%** (last 7 days) vs **36.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **64.9%** (last 7 days) vs **53.8%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **75.8%** (last 7 days) vs **75.3%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job

## Most open times

Based on 32 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (25.6% of GPUs allocated on average) and around **08:00-09:00** (30.0% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2730.5</td><td align='right'>11486.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>39.5</td><td align='right'>3244.5</td><td align='right'>15%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-29 01:00 to 2026-09-05 01:00** (PDT).
