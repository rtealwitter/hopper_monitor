...
Last updated: 2026-08-22T20:30:09-07:00
Samples: 827 queue snapshots total (332 in the last 7 days), 791 GPU snapshots total (300 in the last 7 days)
...
- **25.6%** (last 7 days) vs **41.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **43.6%** (last 7 days) vs **49.8%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **73.4%** (last 7 days) vs **79.3%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1863.5</td><td align='right'>5813.5</td><td align='right'>56%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-15 20:30 to 2026-08-22 20:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3199** readings the former missed.
