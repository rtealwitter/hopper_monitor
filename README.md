...
Last updated: 2026-08-31T13:00:27-07:00
Samples: 1221 queue snapshots total (327 in the last 7 days), 1147 GPU snapshots total (301 in the last 7 days)
...
- **44.7%** (last 7 days) vs **41.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **66.9%** (last 7 days) vs **53.8%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **44.0%** (last 7 days) vs **70.4%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4364.5</td><td align='right'>10655.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 13:00 to 2026-08-31 13:00** (PDT).
...
One point per user per snapshot (n=776), usage decayed on Slurm's ~7-day fairshare half-life.
