...
Last updated: 2026-08-31T16:30:26-07:00
Samples: 1228 queue snapshots total (329 in the last 7 days), 1154 GPU snapshots total (306 in the last 7 days)
...
- **46.0%** (last 7 days) vs **41.3%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.2%** (last 7 days) vs **54.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **43.3%** (last 7 days) vs **69.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4530.0</td><td align='right'>10841.0</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 16:30 to 2026-08-31 16:30** (PDT).
