...
Last updated: 2026-08-11T22:00:25-07:00
Samples: 304 queue snapshots total (304 in the last 7 days), 304 GPU snapshots total (304 in the last 7 days)
...
Based on 7 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (29.6% of GPUs allocated on average) and around **22:00-23:00** (36.2% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2125.5</td><td align='right'>2125.5</td><td align='right'>73%</td><td align='right'>73%</td></tr>
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1874.0</td><td align='right'>1874.0</td><td align='right'>35%</td><td align='right'>35%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-04 22:00 to 2026-08-11 22:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **5954** readings the former missed.
