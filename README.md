...
Last updated: 2026-08-09T10:30:24-07:00
Samples: 185 queue snapshots total (185 in the last 7 days), 185 GPU snapshots total (185 in the last 7 days)
...
- **45.9%** (last 7 days) vs **45.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **48.9%** (last 7 days) vs **48.9%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **84.4%** (last 7 days) vs **84.4%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1174.5</td><td align='right'>1174.5</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>845.0</td><td align='right'>845.0</td><td align='right'>72%</td><td align='right'>72%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 10:30 to 2026-08-09 10:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3492** readings the former missed.
