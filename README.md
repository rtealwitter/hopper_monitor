...
Last updated: 2026-08-07T13:00:19-07:00
Samples: 94 queue snapshots, 94 GPU snapshots
...
- **54.8%** of the cluster's 60 GPUs allocated, averaged across all samples
- **45.5%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **86.6%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>312.5</td><td align='right'>702.5</td><td align='right'>66%</td></tr>
...
<tr style='background-color:#fcf0d8'><td>nerenberg-lab</td><td>user-fedb5feb</td><td align='right'>3.0</td><td align='right'>34.5</td><td align='right'>49%</td></tr>
...
<tr style='background-color:#dfeaf8'><td>enkavi-lab</td><td>user-c21bdaa4</td><td align='right'>0.0</td><td align='right'>58.0</td><td align='right'>—</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3577.5</td><td align='right'>—</td></tr>
</table>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2310** readings the former missed.
...
One point per user per snapshot (n=461), usage decayed on Slurm's ~7-day fairshare half-life.
