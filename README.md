...
Last updated: 2026-08-07T01:00:06-07:00
Samples: 70 queue snapshots, 70 GPU snapshots
...
- **56.7%** of the cluster's 60 GPUs allocated, averaged across all samples
- **42.9%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **84.7%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>149.0</td><td align='right'>274.5</td><td align='right'>69%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3217.5</td><td align='right'>—</td></tr>
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-eec7ffae</td><td align='right'>0.0</td><td align='right'>361.5</td><td align='right'>—</td></tr>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1805** readings the former missed.
...
One point per user per snapshot (n=361), usage decayed on Slurm's ~7-day fairshare half-life.
