...
Last updated: 2026-08-09T04:00:23-07:00
Samples: 172 queue snapshots total (172 in the last 7 days), 172 GPU snapshots total (172 in the last 7 days)
...
- **43.8%** (last 7 days) vs **43.8%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **47.1%** (last 7 days) vs **47.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **86.9%** (last 7 days) vs **86.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1091.0</td><td align='right'>1091.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>637.0</td><td align='right'>637.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 04:00 to 2026-08-09 04:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3181** readings the former missed.
