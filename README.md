...
Last updated: 2026-08-08T20:00:10-07:00
Samples: 156 queue snapshots, 156 GPU snapshots
...
- **42.7%** of the cluster's 60 GPUs allocated, averaged across all samples
- **45.6%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>977.0</td><td align='right'>977.0</td><td align='right'>42%</td></tr>
...
<tr style='background-color:#fce8e0'><td>gillen-lab</td><td>user-b89a87ef</td><td align='right'>0.0</td><td align='right'>924.0</td><td align='right'>—</td></tr>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2875** readings the former missed.
