...
Last updated: 2026-08-06T20:00:15-07:00
Samples: 60 queue snapshots, 60 GPU snapshots
...
- **64.3%** of the cluster's 60 GPUs allocated, averaged across all samples
- **43.0%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **83.5%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#fbebf1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>510.5</td><td align='right'>510.5</td><td align='right'>50%</td></tr>
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>139.0</td><td align='right'>258.0</td><td align='right'>69%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-dad71a72</td><td align='right'>0.0</td><td align='right'>5.0</td><td align='right'>—</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>2985.0</td><td align='right'>—</td></tr>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1755** readings the former missed.
...
One point per user per snapshot (n=325), usage decayed on Slurm's ~7-day fairshare half-life.
