...
Last updated: 2026-09-02T15:30:08-07:00
Samples: 1322 queue snapshots total (336 in the last 7 days), 1243 GPU snapshots total (322 in the last 7 days)
...
- **69.2%** (last 7 days) vs **73.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
Charts below cover the trailing 7 days: **2026-08-26 15:30 to 2026-09-02 15:30** (PDT).
...
One point per user per snapshot (n=1018), usage decayed on Slurm's ~7-day fairshare half-life.
