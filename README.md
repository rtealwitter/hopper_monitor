...
Last updated: 2026-08-09T17:00:11-07:00
Samples: 198 queue snapshots total (198 in the last 7 days), 198 GPU snapshots total (198 in the last 7 days)
...
- **46.5%** (last 7 days) vs **46.5%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **49.7%** (last 7 days) vs **49.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **82.8%** (last 7 days) vs **82.8%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1247.0</td><td align='right'>1247.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>985.0</td><td align='right'>985.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 17:00 to 2026-08-09 17:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3732** readings the former missed.
