...
Last updated: 2026-09-01T12:00:21-07:00
Samples: 1267 queue snapshots total (336 in the last 7 days), 1193 GPU snapshots total (316 in the last 7 days)
...
- **46.4%** (last 7 days) vs **41.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4679.0</td><td align='right'>11202.5</td><td align='right'>67%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 12:00 to 2026-09-01 12:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **759** readings the former missed.
...
One point per user per snapshot (n=889), usage decayed on Slurm's ~7-day fairshare half-life.
