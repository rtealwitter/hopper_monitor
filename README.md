...
Last updated: 2026-08-28T05:00:26-07:00
Samples: 1061 queue snapshots total (313 in the last 7 days), 987 GPU snapshots total (265 in the last 7 days)
...
- **33.3%** (last 7 days) vs **40.2%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **53.7%** (last 7 days) vs **51.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **57.6%** (last 7 days) vs **75.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2959.5</td><td align='right'>8417.0</td><td align='right'>56%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-21 05:00 to 2026-08-28 05:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1493** readings the former missed.
