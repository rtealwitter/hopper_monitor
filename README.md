...
Last updated: 2026-09-01T06:30:10-07:00
Samples: 1256 queue snapshots total (332 in the last 7 days), 1182 GPU snapshots total (311 in the last 7 days)
...
- **45.6%** (last 7 days) vs **69.5%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4665.0</td><td align='right'>11148.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 06:30 to 2026-09-01 06:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **740** readings the former missed.
...
One point per user per snapshot (n=858), usage decayed on Slurm's ~7-day fairshare half-life.
