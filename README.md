...
Last updated: 2026-08-07T15:00:13-07:00
Samples: 98 queue snapshots, 98 GPU snapshots
...
- **53.8%** of the cluster's 60 GPUs allocated, averaged across all samples
- **46.0%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **86.8%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>346.5</td><td align='right'>761.5</td><td align='right'>67%</td></tr>
...
<tr style='background-color:#fcf0d8'><td>nerenberg-lab</td><td>user-fedb5feb</td><td align='right'>5.0</td><td align='right'>36.5</td><td align='right'>47%</td></tr>
...
<tr style='background-color:#dfeaf8'><td>enkavi-lab</td><td>user-c21bdaa4</td><td align='right'>0.0</td><td align='right'>129.0</td><td align='right'>—</td></tr>
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3637.5</td><td align='right'>—</td></tr>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2370** readings the former missed.
...
One point per user per snapshot (n=481), usage decayed on Slurm's ~7-day fairshare half-life.
