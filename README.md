...
Last updated: 2026-08-30T16:00:29-07:00
Samples: 1179 queue snapshots total (313 in the last 7 days), 1105 GPU snapshots total (275 in the last 7 days)
...
- **36.3%** (last 7 days) vs **39.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **64.1%** (last 7 days) vs **52.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **49.3%** (last 7 days) vs **73.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>3397.0</td><td align='right'>9577.0</td><td align='right'>64%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-23 16:00 to 2026-08-30 16:00** (PDT).
...
One point per user per snapshot (n=687), usage decayed on Slurm's ~7-day fairshare half-life.
