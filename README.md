...
Last updated: 2026-08-31T23:30:14-07:00
Samples: 1242 queue snapshots total (332 in the last 7 days), 1168 GPU snapshots total (311 in the last 7 days)
...
- **47.5%** (last 7 days) vs **41.5%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.4%** (last 7 days) vs **54.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **44.9%** (last 7 days) vs **69.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4723.5</td><td align='right'>11100.0</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 23:30 to 2026-08-31 23:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **862** readings the former missed.
...
One point per user per snapshot (n=828), usage decayed on Slurm's ~7-day fairshare half-life.
