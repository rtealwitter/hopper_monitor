...
Last updated: 2026-08-11T09:30:14-07:00
Samples: 279 queue snapshots total (279 in the last 7 days), 279 GPU snapshots total (279 in the last 7 days)
...
- **50.6%** (last 7 days) vs **50.6%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **53.0%** (last 7 days) vs **53.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **78.8%** (last 7 days) vs **78.8%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1725.0</td><td align='right'>1725.0</td><td align='right'>36%</td><td align='right'>36%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-04 09:30 to 2026-08-11 09:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **5498** readings the former missed.
