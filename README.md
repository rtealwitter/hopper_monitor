...
Last updated: 2026-08-31T11:30:26-07:00
Samples: 1218 queue snapshots total (326 in the last 7 days), 1144 GPU snapshots total (300 in the last 7 days)
...
- **44.1%** (last 7 days) vs **40.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **66.6%** (last 7 days) vs **53.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **44.3%** (last 7 days) vs **70.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4293.5</td><td align='right'>10573.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 11:30 to 2026-08-31 11:30** (PDT).
...
One point per user per snapshot (n=772), usage decayed on Slurm's ~7-day fairshare half-life.
