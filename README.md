...
Last updated: 2026-09-02T17:30:09-07:00
Samples: 1326 queue snapshots total (336 in the last 7 days), 1243 GPU snapshots total (322 in the last 7 days)
...
- **45.7%** (last 7 days) vs **39.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **64.9%** (last 7 days) vs **54.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **70.1%** (last 7 days) vs **74.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
Charts below cover the trailing 7 days: **2026-08-26 17:30 to 2026-09-02 17:30** (PDT).
