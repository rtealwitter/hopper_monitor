...
Last updated: 2026-09-04T17:00:07-07:00
Samples: 1421 queue snapshots total (336 in the last 7 days), 1259 GPU snapshots total (248 in the last 7 days)
...
- **73.2%** (last 7 days) vs **74.4%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2768.5</td><td align='right'>11481.0</td><td align='right'>66%</td><td align='right'>64%</td></tr>
...
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-7d156b54</td><td align='right'>13.5</td><td align='right'>16.0</td><td align='right'>37%</td><td align='right'>38%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-28 17:00 to 2026-09-04 17:00** (PDT).
...
2. **Escalate on sustained low utilization** (see table and scatter above). Current top candidate (most idle GPU-hours over the last 7d): `user-554c620c` in `witter-lab` - 937 idle of 2768.5 GPU-hours allocated (66% utilization). Needs a utilization threshold (e.g. <20% mean over 50+ GPU-hours) and a grace period, then either a soft nudge (Slack/email) or a hard QOS penalty (`sacctmgr modify qos ... set Priority-=<n>`). Neither exists yet - this is read-only signal, not enforced policy.
