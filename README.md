...
Last updated: 2026-08-28T14:00:19-07:00
Samples: 1079 queue snapshots total (313 in the last 7 days), 1005 GPU snapshots total (265 in the last 7 days)
...
- **54.6%** (last 7 days) vs **51.4%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **56.1%** (last 7 days) vs **75.1%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>3189.5</td><td align='right'>8691.5</td><td align='right'>56%</td><td align='right'>63%</td></tr>
<tr style='background-color:#fae3e3'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>123.0</td><td align='right'>3205.0</td><td align='right'>18%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-21 14:00 to 2026-08-28 14:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1477** readings the former missed.
...
One point per user per snapshot (n=577), usage decayed on Slurm's ~7-day fairshare half-life.
