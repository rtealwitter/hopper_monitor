...
Last updated: 2026-09-01T07:00:12-07:00
Samples: 1257 queue snapshots total (332 in the last 7 days), 1183 GPU snapshots total (311 in the last 7 days)
...
- **47.0%** (last 7 days) vs **41.2%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.0%** (last 7 days) vs **54.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4666.5</td><td align='right'>11151.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 07:00 to 2026-09-01 07:00** (PDT).
...
One point per user per snapshot (n=860), usage decayed on Slurm's ~7-day fairshare half-life.
