...
Last updated: 2026-08-31T17:30:27-07:00
Samples: 1230 queue snapshots total (330 in the last 7 days), 1156 GPU snapshots total (308 in the last 7 days)
...
- **46.4%** (last 7 days) vs **41.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.3%** (last 7 days) vs **54.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **43.2%** (last 7 days) vs **69.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4585.5</td><td align='right'>10896.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 17:30 to 2026-08-31 17:30** (PDT).
...
One point per user per snapshot (n=798), usage decayed on Slurm's ~7-day fairshare half-life.
