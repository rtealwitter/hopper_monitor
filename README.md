...
Last updated: 2026-08-31T11:00:27-07:00
Samples: 1217 queue snapshots total (325 in the last 7 days), 1143 GPU snapshots total (299 in the last 7 days)
...
- **43.9%** (last 7 days) vs **40.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **66.5%** (last 7 days) vs **53.6%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **44.4%** (last 7 days) vs **70.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4266.0</td><td align='right'>10545.5</td><td align='right'>67%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 11:00 to 2026-08-31 11:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **920** readings the former missed.
