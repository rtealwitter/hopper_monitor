...
Last updated: 2026-08-09T02:00:21-07:00
Samples: 168 queue snapshots total (168 in the last 7 days), 168 GPU snapshots total (168 in the last 7 days)
...
- **43.0%** (last 7 days) vs **43.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **46.1%** (last 7 days) vs **46.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **87.7%** (last 7 days) vs **87.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1066.5</td><td align='right'>1066.5</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>573.0</td><td align='right'>573.0</td><td align='right'>70%</td><td align='right'>70%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 02:00 to 2026-08-09 02:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3088** readings the former missed.
