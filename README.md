...
Last updated: 2026-08-10T05:30:23-07:00
Samples: 223 queue snapshots total (223 in the last 7 days), 223 GPU snapshots total (223 in the last 7 days)
...
- **48.9%** (last 7 days) vs **48.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **52.1%** (last 7 days) vs **52.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1400.5</td><td align='right'>1400.5</td><td align='right'>39%</td><td align='right'>39%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1344.0</td><td align='right'>1344.0</td><td align='right'>74%</td><td align='right'>74%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-03 05:30 to 2026-08-10 05:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **4235** readings the former missed.
...
One point per user per snapshot (n=998), usage decayed on Slurm's ~7-day fairshare half-life.
