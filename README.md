...
Last updated: 2026-08-23T10:30:16-07:00
Samples: 855 queue snapshots total (332 in the last 7 days), 819 GPU snapshots total (300 in the last 7 days)
...
- **25.3%** (last 7 days) vs **40.6%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **40.4%** (last 7 days) vs **49.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **71.8%** (last 7 days) vs **78.8%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1832.0</td><td align='right'>6064.0</td><td align='right'>52%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-16 10:30 to 2026-08-23 10:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2950** readings the former missed.
