...
Last updated: 2026-08-28T02:00:26-07:00
Samples: 1055 queue snapshots total (313 in the last 7 days), 981 GPU snapshots total (265 in the last 7 days)
...
- **32.4%** (last 7 days) vs **40.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **53.3%** (last 7 days) vs **51.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **57.7%** (last 7 days) vs **75.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2870.5</td><td align='right'>8279.0</td><td align='right'>56%</td><td align='right'>64%</td></tr>
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>162.0</td><td align='right'>3205.0</td><td align='right'>18%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-21 02:00 to 2026-08-28 02:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1490** readings the former missed.
