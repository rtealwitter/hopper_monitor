...
Last updated: 2026-08-10T06:00:21-07:00
Samples: 224 queue snapshots total (224 in the last 7 days), 224 GPU snapshots total (224 in the last 7 days)
...
- **49.1%** (last 7 days) vs **49.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **52.2%** (last 7 days) vs **52.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **80.3%** (last 7 days) vs **80.3%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1408.0</td><td align='right'>1408.0</td><td align='right'>38%</td><td align='right'>38%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1360.0</td><td align='right'>1360.0</td><td align='right'>74%</td><td align='right'>74%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-03 06:00 to 2026-08-10 06:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **4259** readings the former missed.
