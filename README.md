...
Last updated: 2026-09-10T21:00:30-07:00
Samples: 1717 queue snapshots total (336 in the last 7 days), 1551 GPU snapshots total (296 in the last 7 days)
...
- **36.4%** (last 7 days) vs **37.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **53.9%** (last 7 days) vs **54.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **96.5%** (last 7 days) vs **83.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1899.5</td><td align='right'>13380.5</td><td align='right'>83%</td><td align='right'>67%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1625.0</td><td align='right'>4830.0</td><td align='right'>22%</td><td align='right'>28%</td></tr>
...
Charts below cover the trailing 7 days: **2026-09-03 21:00 to 2026-09-10 21:00** (PDT).
...
One point per user per snapshot (n=1283), usage decayed on Slurm's ~7-day fairshare half-life.
