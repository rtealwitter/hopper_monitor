...
Last updated: 2026-08-28T06:30:26-07:00
Samples: 1064 queue snapshots total (313 in the last 7 days), 990 GPU snapshots total (265 in the last 7 days)
...
- **33.9%** (last 7 days) vs **40.3%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **53.8%** (last 7 days) vs **51.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **57.6%** (last 7 days) vs **75.5%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>3015.0</td><td align='right'>8486.0</td><td align='right'>56%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-21 06:30 to 2026-08-28 06:30** (PDT).
