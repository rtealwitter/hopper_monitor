...
Last updated: 2026-09-05T06:30:08-07:00
Samples: 1448 queue snapshots total (336 in the last 7 days), 1283 GPU snapshots total (245 in the last 7 days)
...
- **77.3%** (last 7 days) vs **75.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job

## Most open times

Based on 32 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (24.9% of GPUs allocated on average) and around **08:00-09:00** (30.0% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2714.0</td><td align='right'>11486.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>82.0</td><td align='right'>3287.0</td><td align='right'>15%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-29 06:30 to 2026-09-05 06:30** (PDT).
