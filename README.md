...
Last updated: 2026-09-08T06:30:10-07:00
Samples: 1592 queue snapshots total (336 in the last 7 days), 1426 GPU snapshots total (244 in the last 7 days)
...
- **39.0%** (last 7 days) vs **52.5%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>920.5</td><td align='right'>4125.5</td><td align='right'>17%</td><td align='right'>28%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>730.0</td><td align='right'>11878.5</td><td align='right'>64%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-09-01 06:30 to 2026-09-08 06:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **647** readings the former missed.
...
One point per user per snapshot (n=1088), usage decayed on Slurm's ~7-day fairshare half-life.
