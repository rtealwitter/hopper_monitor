...
Last updated: 2026-08-22T22:30:09-07:00
Samples: 831 queue snapshots total (332 in the last 7 days), 795 GPU snapshots total (300 in the last 7 days)
...
- **43.6%** (last 7 days) vs **49.8%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **73.5%** (last 7 days) vs **79.3%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1860.5</td><td align='right'>5829.5</td><td align='right'>56%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-15 22:30 to 2026-08-22 22:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3194** readings the former missed.
