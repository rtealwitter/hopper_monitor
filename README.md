...
Last updated: 2026-08-10T02:00:21-07:00
Samples: 216 queue snapshots total (216 in the last 7 days), 216 GPU snapshots total (216 in the last 7 days)
...
- **48.1%** (last 7 days) vs **48.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **51.2%** (last 7 days) vs **51.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1355.0</td><td align='right'>1355.0</td><td align='right'>39%</td><td align='right'>39%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1232.0</td><td align='right'>1232.0</td><td align='right'>72%</td><td align='right'>72%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-03 02:00 to 2026-08-10 02:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **4085** readings the former missed.
