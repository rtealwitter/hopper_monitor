...
Last updated: 2026-09-06T14:00:11-07:00
Samples: 1511 queue snapshots total (336 in the last 7 days), 1345 GPU snapshots total (244 in the last 7 days)
...
- **24.9%** (last 7 days) vs **36.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **57.0%** (last 7 days) vs **52.9%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **83.6%** (last 7 days) vs **77.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2027.0</td><td align='right'>11498.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>441.5</td><td align='right'>3646.5</td><td align='right'>17%</td><td align='right'>29%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-30 14:00 to 2026-09-06 14:00** (PDT).
