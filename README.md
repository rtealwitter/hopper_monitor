...
Last updated: 2026-09-07T15:30:11-07:00
Samples: 1562 queue snapshots total (336 in the last 7 days), 1396 GPU snapshots total (244 in the last 7 days)
...
- **15.5%** (last 7 days) vs **35.7%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **36.7%** (last 7 days) vs **52.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **92.7%** (last 7 days) vs **80.1%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>755.5</td><td align='right'>3960.5</td><td align='right'>17%</td><td align='right'>28%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>705.0</td><td align='right'>11498.0</td><td align='right'>55%</td><td align='right'>64%</td></tr>
...
<tr style='background-color:#e3e1f1'><td>nerenberg-lab</td><td>user-fedb5feb</td><td align='right'>28.5</td><td align='right'>96.0</td><td align='right'>52%</td><td align='right'>56%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-31 15:30 to 2026-09-07 15:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **540** readings the former missed.
...
One point per user per snapshot (n=1044), usage decayed on Slurm's ~7-day fairshare half-life.
