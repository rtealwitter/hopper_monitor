...
Last updated: 2026-08-10T05:00:21-07:00
Samples: 222 queue snapshots total (222 in the last 7 days), 222 GPU snapshots total (222 in the last 7 days)
...
- **48.8%** (last 7 days) vs **48.8%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **52.0%** (last 7 days) vs **52.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **80.5%** (last 7 days) vs **80.5%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1393.0</td><td align='right'>1393.0</td><td align='right'>39%</td><td align='right'>39%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1328.0</td><td align='right'>1328.0</td><td align='right'>74%</td><td align='right'>74%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-03 05:00 to 2026-08-10 05:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **4212** readings the former missed.
