...
Last updated: 2026-08-06T08:30:12-07:00
Samples: 37 queue snapshots, 37 GPU snapshots
...
- **75.3%** of the cluster's 60 GPUs allocated, averaged across all samples
...
<tr style='background-color:#fbebf1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>269.5</td><td align='right'>269.5</td><td align='right'>47%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>62.0</td><td align='right'>170.5</td><td align='right'>72%</td></tr>
<tr style='background-color:#fcf0d8'><td>nerenberg-lab</td><td>user-6bb5f332</td><td align='right'>37.0</td><td align='right'>185.0</td><td align='right'>71%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-eec7ffae</td><td align='right'>0.0</td><td align='right'>217.0</td><td align='right'>—</td></tr>
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>2167.5</td><td align='right'>—</td></tr>
</table>
...
Attribution is cross-referenced two ways: `nvidia-smi`'s own process listing (misses containerized/namespaced processes), backfilled from Slurm's GPU-to-job binding record (`scontrol show job -dd`). The scontrol fallback attributed **1286** GPU readings this run that the process-listing path missed.
...
Each point is one user at one snapshot (n=225), not averaged over time, to show how a user's position moves rather than collapsing it to a single number. Both axes are usage decayed with Slurm's own ~7-day fairshare half-life (`PriorityDecayHalfLife` on this cluster), not a lifetime total or a per-day average.
