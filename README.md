...
Last updated: 2026-09-05T23:00:11-07:00
Samples: 1481 queue snapshots total (336 in the last 7 days), 1315 GPU snapshots total (244 in the last 7 days)
...
- **27.4%** (last 7 days) vs **36.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **61.3%** (last 7 days) vs **53.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **81.2%** (last 7 days) vs **77.3%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2468.0</td><td align='right'>11498.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>254.0</td><td align='right'>3459.0</td><td align='right'>18%</td><td align='right'>30%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-29 23:00 to 2026-09-05 23:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **607** readings the former missed.
