...
Last updated: 2026-09-01T13:00:19-07:00
Samples: 1269 queue snapshots total (336 in the last 7 days), 1195 GPU snapshots total (316 in the last 7 days)
...
- **46.3%** (last 7 days) vs **41.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **66.5%** (last 7 days) vs **54.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **47.9%** (last 7 days) vs **69.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4665.5</td><td align='right'>11234.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 13:00 to 2026-09-01 13:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **770** readings the former missed.
...
One point per user per snapshot (n=894), usage decayed on Slurm's ~7-day fairshare half-life.
