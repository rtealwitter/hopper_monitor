...
Last updated: 2026-08-09T05:30:25-07:00
Samples: 175 queue snapshots total (175 in the last 7 days), 175 GPU snapshots total (175 in the last 7 days)
...
- **44.2%** (last 7 days) vs **44.2%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **47.4%** (last 7 days) vs **47.4%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **86.3%** (last 7 days) vs **86.3%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1107.0</td><td align='right'>1107.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>685.0</td><td align='right'>685.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 05:30 to 2026-08-09 05:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3261** readings the former missed.
