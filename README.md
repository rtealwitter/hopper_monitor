...
Last updated: 2026-08-30T08:30:13-07:00
Samples: 1164 queue snapshots total (313 in the last 7 days), 1090 GPU snapshots total (275 in the last 7 days)
...
- **60.4%** (last 7 days) vs **51.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>3159.5</td><td align='right'>9179.5</td><td align='right'>60%</td><td align='right'>63%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-23 08:30 to 2026-08-30 08:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **993** readings the former missed.
...
One point per user per snapshot (n=657), usage decayed on Slurm's ~7-day fairshare half-life.
