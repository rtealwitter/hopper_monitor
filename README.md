...
Last updated: 2026-08-31T14:30:28-07:00
Samples: 1224 queue snapshots total (328 in the last 7 days), 1150 GPU snapshots total (302 in the last 7 days)
...
- **45.2%** (last 7 days) vs **41.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.1%** (last 7 days) vs **53.9%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **43.7%** (last 7 days) vs **70.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4427.0</td><td align='right'>10738.0</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 14:30 to 2026-08-31 14:30** (PDT).
...
One point per user per snapshot (n=784), usage decayed on Slurm's ~7-day fairshare half-life.
