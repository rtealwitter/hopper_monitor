...
Last updated: 2026-08-28T19:00:09-07:00
Samples: 1089 queue snapshots total (313 in the last 7 days), 1015 GPU snapshots total (265 in the last 7 days)
...
- **34.9%** (last 7 days) vs **40.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **55.2%** (last 7 days) vs **51.4%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **53.9%** (last 7 days) vs **75.0%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>3185.0</td><td align='right'>8714.5</td><td align='right'>56%</td><td align='right'>63%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-21 19:00 to 2026-08-28 19:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1411** readings the former missed.
