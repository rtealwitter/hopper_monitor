...
Last updated: 2026-09-05T04:00:08-07:00
Samples: 1443 queue snapshots total (336 in the last 7 days), 1278 GPU snapshots total (245 in the last 7 days)
...
- **64.5%** (last 7 days) vs **53.8%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **76.6%** (last 7 days) vs **75.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job

## Most open times

Based on 32 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (25.3% of GPUs allocated on average) and around **08:00-09:00** (30.0% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2716.5</td><td align='right'>11486.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>70.0</td><td align='right'>3275.0</td><td align='right'>19%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-29 04:00 to 2026-09-05 04:00** (PDT).
