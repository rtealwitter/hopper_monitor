...
Last updated: 2026-08-25T07:00:06-07:00
Samples: 925 queue snapshots total (313 in the last 7 days), 872 GPU snapshots total (277 in the last 7 days)
...
- **22.9%** (last 7 days) vs **39.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **41.1%** (last 7 days) vs **49.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1754.5</td><td align='right'>6485.0</td><td align='right'>47%</td><td align='right'>63%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-d58f5a15</td><td align='right'>260.0</td><td align='right'>1023.5</td><td align='right'>5%</td><td align='right'>7%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-18 07:00 to 2026-08-25 07:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2241** readings the former missed.
...
One point per user per snapshot (n=777), usage decayed on Slurm's ~7-day fairshare half-life.
