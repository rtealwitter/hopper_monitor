...
Last updated: 2026-08-07T00:30:06-07:00
Samples: 69 queue snapshots, 69 GPU snapshots
...
- **57.5%** of the cluster's 60 GPUs allocated, averaged across all samples
- **42.9%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **84.6%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>148.0</td><td align='right'>273.5</td><td align='right'>69%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-eec7ffae</td><td align='right'>0.0</td><td align='right'>351.0</td><td align='right'>—</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3202.5</td><td align='right'>—</td></tr>
</table>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1803** readings the former missed.
...
One point per user per snapshot (n=358), usage decayed on Slurm's ~7-day fairshare half-life.
