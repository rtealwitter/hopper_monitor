...
Last updated: 2026-08-06T21:00:16-07:00
Samples: 62 queue snapshots, 62 GPU snapshots
...
- **63.1%** of the cluster's 60 GPUs allocated, averaged across all samples
- **43.0%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **83.6%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#fbebf1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>525.5</td><td align='right'>525.5</td><td align='right'>49%</td></tr>
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>141.0</td><td align='right'>260.5</td><td align='right'>69%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-eec7ffae</td><td align='right'>0.0</td><td align='right'>252.0</td><td align='right'>—</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3045.0</td><td align='right'>—</td></tr>
</table>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1783** readings the former missed.
...
One point per user per snapshot (n=334), usage decayed on Slurm's ~7-day fairshare half-life.
