...
Last updated: 2026-08-09T08:30:20-07:00
Samples: 181 queue snapshots total (181 in the last 7 days), 181 GPU snapshots total (181 in the last 7 days)
...
- **48.3%** (last 7 days) vs **48.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **85.1%** (last 7 days) vs **85.1%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1144.5</td><td align='right'>1144.5</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>781.0</td><td align='right'>781.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 08:30 to 2026-08-09 08:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3397** readings the former missed.
...
One point per user per snapshot (n=826), usage decayed on Slurm's ~7-day fairshare half-life.
