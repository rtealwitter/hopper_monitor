...
Last updated: 2026-08-09T12:00:27-07:00
Samples: 188 queue snapshots total (188 in the last 7 days), 188 GPU snapshots total (188 in the last 7 days)
...
- **46.3%** (last 7 days) vs **46.3%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **49.5%** (last 7 days) vs **49.5%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **83.9%** (last 7 days) vs **83.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1190.0</td><td align='right'>1190.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>893.0</td><td align='right'>893.0</td><td align='right'>72%</td><td align='right'>72%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 12:00 to 2026-08-09 12:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3557** readings the former missed.
