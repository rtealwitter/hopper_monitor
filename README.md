...
Last updated: 2026-09-05T00:00:08-07:00
Samples: 1435 queue snapshots total (336 in the last 7 days), 1270 GPU snapshots total (245 in the last 7 days)
...
- **75.5%** (last 7 days) vs **75.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job

## Most open times

Based on 32 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (25.7% of GPUs allocated on average) and around **08:00-09:00** (30.0% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2729.0</td><td align='right'>11481.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>35.5</td><td align='right'>3240.5</td><td align='right'>17%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-29 00:00 to 2026-09-05 00:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **623** readings the former missed.
