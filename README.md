...
Last updated: 2026-08-21T22:00:12-07:00
Samples: 782 queue snapshots total (334 in the last 7 days), 756 GPU snapshots total (308 in the last 7 days)
...
- **42.3%** (last 7 days) vs **50.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1769.0</td><td align='right'>5610.0</td><td align='right'>56%</td><td align='right'>66%</td></tr>
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>345.5</td><td align='right'>3122.0</td><td align='right'>23%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-14 22:00 to 2026-08-21 22:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3444** readings the former missed.
...
One point per user per snapshot (n=1067), usage decayed on Slurm's ~7-day fairshare half-life.
