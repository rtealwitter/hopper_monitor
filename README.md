...
Last updated: 2026-08-22T12:00:11-07:00
Samples: 810 queue snapshots total (332 in the last 7 days), 774 GPU snapshots total (298 in the last 7 days)
...
- **42.1%** (last 7 days) vs **49.8%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **74.4%** (last 7 days) vs **79.4%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job

## Most open times

Based on 18 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (26.7% of GPUs allocated on average) and around **01:00-02:00** (35.6% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1780.5</td><td align='right'>5700.0</td><td align='right'>56%</td><td align='right'>66%</td></tr>
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>221.0</td><td align='right'>3168.0</td><td align='right'>11%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-15 12:00 to 2026-08-22 12:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3241** readings the former missed.
