...
Last updated: 2026-08-23T09:30:08-07:00
Samples: 853 queue snapshots total (332 in the last 7 days), 817 GPU snapshots total (300 in the last 7 days)
...
- **40.8%** (last 7 days) vs **49.4%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1808.0</td><td align='right'>6032.0</td><td align='right'>52%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-16 09:30 to 2026-08-23 09:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2946** readings the former missed.
