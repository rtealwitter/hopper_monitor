...
Last updated: 2026-09-06T23:00:10-07:00
Samples: 1529 queue snapshots total (336 in the last 7 days), 1363 GPU snapshots total (244 in the last 7 days)
...
- **22.0%** (last 7 days) vs **35.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **53.3%** (last 7 days) vs **52.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **87.0%** (last 7 days) vs **78.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1612.5</td><td align='right'>11498.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>560.0</td><td align='right'>3765.0</td><td align='right'>17%</td><td align='right'>29%</td></tr>
...
<tr style='background-color:#e3e1f1'><td>nerenberg-lab</td><td>user-7eb22d7c</td><td align='right'>6.0</td><td align='right'>6.0</td><td align='right'>66%</td><td align='right'>66%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-30 23:00 to 2026-09-06 23:00** (PDT).
...
One point per user per snapshot (n=973), usage decayed on Slurm's ~7-day fairshare half-life.
