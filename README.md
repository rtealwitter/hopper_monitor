...
Last updated: 2026-08-09T06:30:26-07:00
Samples: 177 queue snapshots total (177 in the last 7 days), 177 GPU snapshots total (177 in the last 7 days)
...
- **44.6%** (last 7 days) vs **44.6%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **48.0%** (last 7 days) vs **48.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **85.9%** (last 7 days) vs **85.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1122.0</td><td align='right'>1122.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>717.0</td><td align='right'>717.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 06:30 to 2026-08-09 06:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3307** readings the former missed.
