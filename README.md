...
Last updated: 2026-09-01T03:00:10-07:00
Samples: 1249 queue snapshots total (332 in the last 7 days), 1175 GPU snapshots total (311 in the last 7 days)
...
- **67.3%** (last 7 days) vs **54.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4669.0</td><td align='right'>11124.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 03:00 to 2026-09-01 03:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **778** readings the former missed.
...
One point per user per snapshot (n=844), usage decayed on Slurm's ~7-day fairshare half-life.
