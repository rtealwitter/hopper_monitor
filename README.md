...
Last updated: 2026-08-09T00:30:21-07:00
Samples: 165 queue snapshots total (165 in the last 7 days), 165 GPU snapshots total (165 in the last 7 days)
...
- **42.4%** (last 7 days) vs **42.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **45.5%** (last 7 days) vs **45.5%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **88.3%** (last 7 days) vs **88.3%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1044.0</td><td align='right'>1044.0</td><td align='right'>41%</td><td align='right'>41%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>525.0</td><td align='right'>525.0</td><td align='right'>68%</td><td align='right'>68%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 00:30 to 2026-08-09 00:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3018** readings the former missed.
