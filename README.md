...
Last updated: 2026-08-09T01:30:22-07:00
Samples: 167 queue snapshots total (167 in the last 7 days), 167 GPU snapshots total (167 in the last 7 days)
...
- **42.8%** (last 7 days) vs **42.8%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **45.9%** (last 7 days) vs **45.9%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **87.9%** (last 7 days) vs **87.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1059.0</td><td align='right'>1059.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>557.0</td><td align='right'>557.0</td><td align='right'>69%</td><td align='right'>69%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 01:30 to 2026-08-09 01:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3065** readings the former missed.
...
One point per user per snapshot (n=770), usage decayed on Slurm's ~7-day fairshare half-life.
