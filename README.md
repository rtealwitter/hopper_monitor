...
Last updated: 2026-08-07T11:00:27-07:00
Samples: 90 queue snapshots, 90 GPU snapshots
...
- **55.2%** of the cluster's 60 GPUs allocated, averaged across all samples
- **45.0%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **86.4%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>260.0</td><td align='right'>614.5</td><td align='right'>68%</td></tr>
...
<tr style='background-color:#fcf0d8'><td>nerenberg-lab</td><td>user-fedb5feb</td><td align='right'>1.0</td><td align='right'>32.5</td><td align='right'>57%</td></tr>
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3517.5</td><td align='right'>—</td></tr>
...
<tr style='background-color:#dfeaf8'><td>enkavi-lab</td><td>user-c21bdaa4</td><td align='right'>0.0</td><td align='right'>50.0</td><td align='right'>—</td></tr>
</table>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2222** readings the former missed.
...
One point per user per snapshot (n=441), usage decayed on Slurm's ~7-day fairshare half-life.
