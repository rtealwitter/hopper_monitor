...
Last updated: 2026-08-10T03:30:18-07:00
Samples: 219 queue snapshots total (219 in the last 7 days), 219 GPU snapshots total (219 in the last 7 days)
...
- **51.5%** (last 7 days) vs **51.5%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **80.7%** (last 7 days) vs **80.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1370.5</td><td align='right'>1370.5</td><td align='right'>38%</td><td align='right'>38%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1280.0</td><td align='right'>1280.0</td><td align='right'>73%</td><td align='right'>73%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-03 03:30 to 2026-08-10 03:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **4144** readings the former missed.
...
One point per user per snapshot (n=982), usage decayed on Slurm's ~7-day fairshare half-life.
