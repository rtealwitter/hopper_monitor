...
Last updated: 2026-08-13T14:30:23-07:00
Samples: 385 queue snapshots total (336 in the last 7 days), 385 GPU snapshots total (336 in the last 7 days)
...
- **53.1%** (last 7 days) vs **54.9%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **55.8%** (last 7 days) vs **53.4%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **79.7%** (last 7 days) vs **80.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>3291.0</td><td align='right'>3399.5</td><td align='right'>70%</td><td align='right'>70%</td></tr>
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1987.0</td><td align='right'>2364.0</td><td align='right'>31%</td><td align='right'>34%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-06 14:30 to 2026-08-13 14:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **6893** readings the former missed.
