...
Last updated: 2026-08-23T00:00:16-07:00
Samples: 834 queue snapshots total (332 in the last 7 days), 798 GPU snapshots total (300 in the last 7 days)
...
- **43.3%** (last 7 days) vs **49.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **73.3%** (last 7 days) vs **79.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1856.0</td><td align='right'>5873.0</td><td align='right'>56%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-16 00:00 to 2026-08-23 00:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3144** readings the former missed.
