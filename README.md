...
Last updated: 2026-09-08T03:30:28-07:00
Samples: 1586 queue snapshots total (336 in the last 7 days), 1420 GPU snapshots total (244 in the last 7 days)
...
- **16.6%** (last 7 days) vs **36.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **37.3%** (last 7 days) vs **52.4%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>889.5</td><td align='right'>4094.5</td><td align='right'>17%</td><td align='right'>28%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>671.0</td><td align='right'>11799.0</td><td align='right'>61%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-09-01 03:30 to 2026-09-08 03:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **626** readings the former missed.
...
One point per user per snapshot (n=1082), usage decayed on Slurm's ~7-day fairshare half-life.
