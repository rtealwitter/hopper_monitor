...
Last updated: 2026-08-31T15:00:28-07:00
Samples: 1225 queue snapshots total (328 in the last 7 days), 1151 GPU snapshots total (303 in the last 7 days)
...
- **45.5%** (last 7 days) vs **41.2%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.2%** (last 7 days) vs **54.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **43.6%** (last 7 days) vs **70.1%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4454.5</td><td align='right'>10765.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 15:00 to 2026-08-31 15:00** (PDT).
...
One point per user per snapshot (n=786), usage decayed on Slurm's ~7-day fairshare half-life.
