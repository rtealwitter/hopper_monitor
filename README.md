...
Last updated: 2026-09-05T18:00:07-07:00
Samples: 1471 queue snapshots total (336 in the last 7 days), 1306 GPU snapshots total (245 in the last 7 days)
...
- **28.2%** (last 7 days) vs **36.5%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **62.7%** (last 7 days) vs **53.4%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **80.0%** (last 7 days) vs **77.0%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>2615.5</td><td align='right'>11498.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>192.0</td><td align='right'>3397.0</td><td align='right'>15%</td><td align='right'>30%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-29 18:00 to 2026-09-05 18:00** (PDT).
