...
Last updated: 2026-08-31T14:00:28-07:00
Samples: 1223 queue snapshots total (327 in the last 7 days), 1149 GPU snapshots total (301 in the last 7 days)
...
- **45.0%** (last 7 days) vs **41.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **67.0%** (last 7 days) vs **53.9%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **43.8%** (last 7 days) vs **70.3%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4399.5</td><td align='right'>10710.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-24 14:00 to 2026-08-31 14:00** (PDT).
...
One point per user per snapshot (n=781), usage decayed on Slurm's ~7-day fairshare half-life.
