...
Last updated: 2026-09-01T10:30:11-07:00
Samples: 1264 queue snapshots total (335 in the last 7 days), 1190 GPU snapshots total (315 in the last 7 days)
...
- **46.6%** (last 7 days) vs **41.0%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **66.7%** (last 7 days) vs **54.1%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **47.0%** (last 7 days) vs **69.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4685.5</td><td align='right'>11179.0</td><td align='right'>67%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 10:30 to 2026-09-01 10:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **749** readings the former missed.
...
One point per user per snapshot (n=881), usage decayed on Slurm's ~7-day fairshare half-life.
