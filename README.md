...
Last updated: 2026-08-22T23:30:17-07:00
Samples: 833 queue snapshots total (332 in the last 7 days), 797 GPU snapshots total (300 in the last 7 days)
...
- **43.5%** (last 7 days) vs **49.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **73.4%** (last 7 days) vs **79.2%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1856.0</td><td align='right'>5857.0</td><td align='right'>56%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-15 23:30 to 2026-08-22 23:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3157** readings the former missed.
