...
Last updated: 2026-08-22T00:35:43-07:00
Samples: 787 queue snapshots total (334 in the last 7 days), 761 GPU snapshots total (308 in the last 7 days)
...
- **27.2%** (last 7 days) vs **42.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **43.0%** (last 7 days) vs **50.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **75.5%** (last 7 days) vs **79.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1828.0</td><td align='right'>5669.0</td><td align='right'>56%</td><td align='right'>66%</td></tr>
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>324.5</td><td align='right'>3122.0</td><td align='right'>24%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-15 00:35 to 2026-08-22 00:35** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3480** readings the former missed.
...
One point per user per snapshot (n=1059), usage decayed on Slurm's ~7-day fairshare half-life.
