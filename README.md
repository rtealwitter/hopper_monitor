...
Last updated: 2026-08-11T15:30:11-07:00
Samples: 291 queue snapshots total (291 in the last 7 days), 291 GPU snapshots total (291 in the last 7 days)
...
- **52.2%** (last 7 days) vs **52.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1800.0</td><td align='right'>1800.0</td><td align='right'>35%</td><td align='right'>35%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-04 15:30 to 2026-08-11 15:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **5645** readings the former missed.
...
One point per user per snapshot (n=1319), usage decayed on Slurm's ~7-day fairshare half-life.
