...
Last updated: 2026-08-09T02:30:18-07:00
Samples: 169 queue snapshots total (169 in the last 7 days), 169 GPU snapshots total (169 in the last 7 days)
...
- **43.1%** (last 7 days) vs **43.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **46.3%** (last 7 days) vs **46.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **87.4%** (last 7 days) vs **87.4%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1068.5</td><td align='right'>1068.5</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>589.0</td><td align='right'>589.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 02:30 to 2026-08-09 02:30** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3105** readings the former missed.
