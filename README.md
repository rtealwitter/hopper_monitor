...
Last updated: 2026-08-09T09:00:25-07:00
Samples: 182 queue snapshots total (182 in the last 7 days), 182 GPU snapshots total (182 in the last 7 days)
...
- **45.4%** (last 7 days) vs **45.4%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **48.6%** (last 7 days) vs **48.6%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **84.9%** (last 7 days) vs **84.9%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8ecd8'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1152.0</td><td align='right'>1152.0</td><td align='right'>40%</td><td align='right'>40%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>797.0</td><td align='right'>797.0</td><td align='right'>71%</td><td align='right'>71%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-02 09:00 to 2026-08-09 09:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3420** readings the former missed.
...
One point per user per snapshot (n=830), usage decayed on Slurm's ~7-day fairshare half-life.
