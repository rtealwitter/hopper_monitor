...
Last updated: 2026-08-07T06:30:08-07:00
Samples: 81 queue snapshots, 81 GPU snapshots
...
- **53.3%** of the cluster's 60 GPUs allocated, averaged across all samples
- **43.5%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **85.7%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#fbebf1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>628.0</td><td align='right'>628.0</td><td align='right'>48%</td></tr>
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>159.0</td><td align='right'>333.0</td><td align='right'>68%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-eec7ffae</td><td align='right'>0.0</td><td align='right'>423.5</td><td align='right'>—</td></tr>
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3382.5</td><td align='right'>—</td></tr>
</table>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1953** readings the former missed.
...
One point per user per snapshot (n=404), usage decayed on Slurm's ~7-day fairshare half-life.
