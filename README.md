...
Last updated: 2026-08-10T04:00:22-07:00
Samples: 220 queue snapshots total (220 in the last 7 days), 220 GPU snapshots total (220 in the last 7 days)
...
- **48.5%** (last 7 days) vs **48.5%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **51.7%** (last 7 days) vs **51.7%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>1378.0</td><td align='right'>1378.0</td><td align='right'>39%</td><td align='right'>39%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1296.0</td><td align='right'>1296.0</td><td align='right'>73%</td><td align='right'>73%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-03 04:00 to 2026-08-10 04:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **4167** readings the former missed.
...
One point per user per snapshot (n=986), usage decayed on Slurm's ~7-day fairshare half-life.
