...
Last updated: 2026-08-05T05:00:17-07:00
...
- **59.6%** average `nvidia-smi` utilization *when* a GPU is allocated to a job

## Per lab / per user

| Lab | User | GPU-hours allocated | CPU-hours allocated | GPU utilization |
|---|---|---:|---:|---:|
| witter-lab | user-d58f5a15 | 250.3 | 2002.4 | 8% |
| zhuang-lab | user-0db9ced0 | 101.7 | 102.2 | 53% |
| witter-lab | user-554c620c | 43.2 | 333.8 | 92% |
| nerenberg-lab | user-6bb5f332 | 15.0 | 75.0 | 78% |
| ibarragarciapadilla-lab | user-3cfc41a3 | 0.0 | 994.9 | — |
| ibarragarciapadilla-lab | user-eec7ffae | 0.0 | 24.9 | — |
...
|---|---|---:|
| user-0db9ced0 | zhuang-lab | 17.1 |
| user-d58f5a15 | witter-lab | 10.6 |
| user-6bb5f332 | nerenberg-lab | 3.5 |
