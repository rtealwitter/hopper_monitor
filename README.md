...
Last updated: 2026-08-22T00:00:17-07:00
Samples: 786 queue snapshots total (334 in the last 7 days), 760 GPU snapshots total (308 in the last 7 days)
...
- **27.1%** (last 7 days) vs **42.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **42.9%** (last 7 days) vs **50.0%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **75.6%** (last 7 days) vs **79.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job

## Most open times

Based on 18 days of history so far, `hopper.cluster` has historically been most open on **Saturdays** (30.3% of GPUs allocated on average) and around **09:00-10:00** (37.4% of GPUs allocated on average). Recomputed from all-time data on every cron tick, so it sharpens as more history accumulates.
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1818.0</td><td align='right'>5659.0</td><td align='right'>56%</td><td align='right'>66%</td></tr>
...
<tr style='background-color:#e3e1f1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>325.5</td><td align='right'>3122.0</td><td align='right'>24%</td><td align='right'>31%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-15 00:00 to 2026-08-22 00:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **3473** readings the former missed.
