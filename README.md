...
Last updated: 2026-08-23T10:00:18-07:00
Samples: 854 queue snapshots total (332 in the last 7 days), 818 GPU snapshots total (300 in the last 7 days)
...
- **25.1%** (last 7 days) vs **40.6%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **40.6%** (last 7 days) vs **49.4%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **71.9%** (last 7 days) vs **78.8%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>1820.0</td><td align='right'>6048.0</td><td align='right'>52%</td><td align='right'>64%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-16 10:00 to 2026-08-23 10:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2948** readings the former missed.
