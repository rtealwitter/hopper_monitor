...
Last updated: 2026-09-01T02:00:12-07:00
Samples: 1247 queue snapshots total (332 in the last 7 days), 1173 GPU snapshots total (311 in the last 7 days)
...
- **45.5%** (last 7 days) vs **69.7%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4677.5</td><td align='right'>11117.5</td><td align='right'>67%</td><td align='right'>65%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 02:00 to 2026-09-01 02:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **797** readings the former missed.
...
One point per user per snapshot (n=840), usage decayed on Slurm's ~7-day fairshare half-life.
