...
Last updated: 2026-08-06T22:00:08-07:00
Samples: 64 queue snapshots, 64 GPU snapshots
...
- **61.6%** of the cluster's 60 GPUs allocated, averaged across all samples
- **42.8%** average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **84.0%** average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#fbebf1'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>533.0</td><td align='right'>533.0</td><td align='right'>49%</td></tr>
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>143.0</td><td align='right'>262.5</td><td align='right'>68%</td></tr>
...
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-3cfc41a3</td><td align='right'>0.0</td><td align='right'>3097.5</td><td align='right'>—</td></tr>
<tr style='background-color:#fce8e0'><td>ibarragarciapadilla-lab</td><td>user-eec7ffae</td><td align='right'>0.0</td><td align='right'>284.0</td><td align='right'>—</td></tr>
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **1799** readings the former missed.
...
One point per user per snapshot (n=342), usage decayed on Slurm's ~7-day fairshare half-life.
