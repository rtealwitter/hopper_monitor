...
Last updated: 2026-08-24T01:00:02-07:00
Samples: 877 queue snapshots total (325 in the last 7 days), 837 GPU snapshots total (289 in the last 7 days)
...
- **23.9%** (last 7 days) vs **40.3%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **38.6%** (last 7 days) vs **49.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-d58f5a15</td><td align='right'>440.5</td><td align='right'>1023.5</td><td align='right'>5%</td><td align='right'>7%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-17 01:00 to 2026-08-24 01:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **2595** readings the former missed.
...
One point per user per snapshot (n=907), usage decayed on Slurm's ~7-day fairshare half-life.
