...
Last updated: 2026-09-01T19:00:19-07:00
Samples: 1281 queue snapshots total (336 in the last 7 days), 1207 GPU snapshots total (318 in the last 7 days)
...
- **47.3%** (last 7 days) vs **41.1%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **66.2%** (last 7 days) vs **54.2%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
- **54.5%** (last 7 days) vs **70.6%** (all time) average cgroup CPU utilization *when* a CPU is allocated to a job
...
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-554c620c</td><td align='right'>4761.0</td><td align='right'>11413.0</td><td align='right'>66%</td><td align='right'>64%</td></tr>
<tr style='background-color:#d8efef'><td>witter-lab</td><td>user-f5bf0d80</td><td align='right'>10.0</td><td align='right'>42.5</td><td align='right'>18%</td><td align='right'>39%</td></tr>
...
Charts below cover the trailing 7 days: **2026-08-25 19:00 to 2026-09-01 19:00** (PDT).
