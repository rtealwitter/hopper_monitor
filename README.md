...
Last updated: 2026-09-21T18:00:26-07:00
Samples: 2235 queue snapshots total (332 in the last 7 days), 2026 GPU snapshots total (289 in the last 7 days)
...
- **35.8%** (last 7 days) vs **38.3%** (all time) of the cluster's 60 GPUs allocated, averaged across samples
- **27.0%** (last 7 days) vs **50.3%** (all time) average `nvidia-smi` utilization *when* a GPU is allocated to a job
...
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-0db9ced0</td><td align='right'>2511.0</td><td align='right'>8492.5</td><td align='right'>21%</td><td align='right'>25%</td></tr>
...
<tr style='background-color:#e3e1f1'><td>nerenberg-lab</td><td>user-7eb22d7c</td><td align='right'>314.0</td><td align='right'>568.5</td><td align='right'>—</td><td align='right'>67%</td></tr>
...
<tr style='background-color:#ededec'><td>zhuang-lab</td><td>user-e67a8f7c</td><td align='right'>26.0</td><td align='right'>27.0</td><td align='right'>77%</td><td align='right'>74%</td></tr>
...
Charts below cover the trailing 7 days: **2026-09-14 18:00 to 2026-09-21 18:00** (PDT).
...
Attribution combines `nvidia-smi`'s process listing with Slurm's GPU-to-job binding record; the latter caught **784** readings the former missed.
...
One point per user per snapshot (n=1450), usage decayed on Slurm's ~7-day fairshare half-life.
